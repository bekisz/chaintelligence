...
def sync_tvl_manual():
    ...
    logging.info("Starting Manual TVL Sync...")
    
    fetcher = UniswapV3Fetcher(verbose=True)
    # Use the connection string environment variable or fallback
    ...
    # OVERRIDE with known Ethereum Mainnet addresses to ensure Graph query works
    mainnet_overrides = {
