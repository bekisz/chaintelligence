...
CREATE TABLE IF NOT EXISTS coin (
    coin_id INTEGER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    symbol VARCHAR(10) NOT NULL UNIQUE,
    name VARCHAR(255),
    slug VARCHAR(255),
    hardness INTEGER DEFAULT 0,
    cmc_rank INTEGER,
    cmc_id INTEGER CONSTRAINT uq_coin_cmc_id UNIQUE,
...
CREATE TABLE IF NOT EXISTS liquidity_pool (
    ...
    fee_tier VARCHAR(10),
    coin0_id INTEGER NOT NULL REFERENCES coin(coin_id) ON DELETE CASCADE,
    coin1_id INTEGER NOT NULL REFERENCES coin(coin_id) ON DELETE CASCADE,
