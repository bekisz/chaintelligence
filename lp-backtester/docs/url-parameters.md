...
### Multiple Strategies
`?token1=eth&strategy[1].name=Wide&strategy[1].range.min=-50&strategy[1].range.max=100&strategy[1].type=simple&strategy[2].name=Narrow&strategy[2].range.min=-10&strategy[2].range.max=10&strategy[2].type=simple`

### eth-USDC with 20% APR and Time-delayed Rebalancing
`?token1=eth&token2=usdc&apr=20&strategy[1].name=DelayedStrategy&strategy[1].type=time-delayed&strategy[1].rebalance.delay=7`
